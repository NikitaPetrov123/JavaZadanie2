...
// Лабораторная работа №2 по языку программирования Java. Выполнил: Петров Никита, 3 курс, 6 группа
...
public class ExpressionEvaluator {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Вводите свое выражение: ");
        ...
        try {
            ...
            System.err.println("Ошибка в: " + e.getMessage());
        }
    }
    /**
    ...
    /**
     * Функция isNumeric используется для проверки того является ли строка числом.
     * Функция isOperator используется для проверки того является ли строка оператором.
     * Функция precedence используется для возвращения приоритета оператора в выражении.
     */
